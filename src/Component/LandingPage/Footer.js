    ...
    return (
        <>
            <div className="py-10 bg-blue-300">
                <h1 className='font-black text-4xl text-center'>Explore, Apply, Succeed</h1>
            </div>
                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                <h2 className="text-white mb-6 text-sm font-bold text-gray-900 uppercase">
                                    Resources
                                </h2>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            ...
                            <a
                                href="#"
                                className="text-blue-300 hover:text-gray-900 ms-5"
                            >
                                <svg
                                    className="w-4 h-4"
                                    aria-hidden="true"
